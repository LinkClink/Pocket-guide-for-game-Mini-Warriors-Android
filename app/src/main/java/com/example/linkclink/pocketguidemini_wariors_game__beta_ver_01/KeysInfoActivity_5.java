...
public class KeysInfoActivity_5 extends AppCompatActivity
{
    ...
    // Strings data sql
    String[] list_names = {"Shop price: ","Legion shop price: ","Open: "};
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_keys_info_5);
    ...
    public  void sql_data_to_info()
    {
        ...
        imageView_icon = (ImageView) findViewById(R.id.imageview_keys);

        textView_name = (TextView) findViewById(R.id.textview_keys_name_1);
        textView_type = (TextView) findViewById(R.id.textview_keys_type_1);
        list1 = (ListView) findViewById(R.id.listview_keys);

        Cursor cursor_data = database.rawQuery(" SELECT * FROM " + table_name +" WHERE id= " + button_id , null);
        cursor_data.moveToFirst();

        // Icon
        drawable_icon_link = getResources().getIdentifier(cursor_data.getString(5), "drawable", getPackageName());
